...
// 스프링6(스프링부터3) 부터 javax -> jakarta로 변경됨
...
// @NoArgsConstructor : 매개변수가 없는 기본생성자를 자동으로 생성하는 어노테이션
...
public class Member {
    ...
    // SEQUENCE : 데잍 베이스 시퀀스를 사용하여 기본 키를 설정(oracle에서 사용함)
    // TABLE : 키 생성 테이블을 사용함
    @Id
    ...
    // 기본적으로 자바 클래스에서 카멜 명명법 사용시, 데이터 베이스에서 슽네이크 명명법으로 적용
    // unique : 컬럼의 유니크 여부 옵션을 설정
