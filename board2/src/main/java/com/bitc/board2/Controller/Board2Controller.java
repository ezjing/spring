...
public class Board2Controller {
    ...
    @GetMapping("/") // @RequestMapping 사용 해도 됨 @Get/PostMapping 은 메소드 방식을 확실히 보여주기 위함
    ...
    public ModelAndView oenBoard2Detail(@RequestParam int boardIdx, HttpServletRequest req) throws Exception {
        ModelAndView mv = new ModelAndView("board2/openBoard2Detail");

//        // 세션에 로그인 정보가 없을 경우 딭일 페이지를 확인할 수 없도록 수정
//        // 세션 정보 가져옴
