...
// @EntityListeners : Entity를 데이터베이스에 적용하기 전후로 AuditingEntityListener의 콜백을 요청할 수 있도록 하는 어노테이션
// AuditingEntityListener : Entity의 Auditing 정보를 주입하는 JPA Entity 리스너 클래스
@Getter
@Setter
@ToString
@MappedSuperclass   // 필수
@EntityListeners(AuditingEntityListener.class)  // 공통적으로 사용하는 Entity, 필수
...
//    private String createId;
    ...
    // @LastModifiedBy : JPA Audit에서 제공하는 어노테이션을 누간 데이터를 수정했는지 값을 자동으로 주입함
//    @LastModifiedBy
//    @Column(nullable = true) // 컬럼의 기본값인 true를 사용한다면 생략 가능
